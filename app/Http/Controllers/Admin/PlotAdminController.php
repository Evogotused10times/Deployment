...
class PlotAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'plot_type'    => ['nullable', 'string'], // ← NEW (optional)
            // 'service_type' => ['nullable', 'string'], // if used
        ]);
    ...
    public function update(Request $request, Plot $plot)
    {
        $data = $request->validate([
            ...
            'plot_type'        => ['nullable', 'string'], // ← NEW
            // 'service_type'     => ['nullable', 'string'], // if used
        ]);

        // Only keys present in $data are updated
        $plot->update($data);
    ...
    public function import(Request $request)
    {
        ...
        foreach ($geo['features'] as $feature) {
            ...
            Plot::create([
                ...
                'plot_type'   => $props['plot_type'] ?? null,     // ← NEW
                // 'service_type' => $props['service_type'] ?? null, // OPTIONAL
            ]);
